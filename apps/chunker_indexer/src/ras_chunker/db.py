...
def upsert_document(conn: psycopg.Connection, meta: DocMeta) -> None:
    ...
    conn.execute(
        ...
        ON CONFLICT (doc_id) DO UPDATE SET
            ...
            editor = COALESCE(EXCLUDED.editor, documents.editor),
            year = COALESCE(EXCLUDED.year, documents.year),
            publication = COALESCE(EXCLUDED.publication, documents.publication),
            ...
            keywords = CASE WHEN EXCLUDED.keywords = '{}'::text[] THEN documents.keywords
            ...
            issn = COALESCE(EXCLUDED.issn, documents.issn),
            series = COALESCE(EXCLUDED.series, documents.series),
            description = COALESCE(EXCLUDED.description, documents.description),
            volume = COALESCE(EXCLUDED.volume, documents.volume),
            issue = COALESCE(EXCLUDED.issue, documents.issue),
            page_range_label = COALESCE(EXCLUDED.page_range_label, documents.page_range_label),
