"""Alibaba Function Compute handler: OSS event on processed JSONL → chunk + embed + index.
...
class FCHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        try:
            ...
            import ras_chunker.lambda_handler as handler
...
if __name__ == "__main__":
    ...
    logger.info("FC chunker handler listening on port %d", FC_PORT)
